...
public class Conexion extends Thread{
    ...
    public Integer insertarCancion(Cancion cancion) throws ExcepcionBP, ExcepcionBPComunicaciones {
        ...
        try {
            ...
            ObjectOutputStream oos = new ObjectOutputStream(socketCliente.getOutputStream());
            Peticion peticion = new Peticion(Peticion.INSERTAR_CANCION, cancion);
            oos.writeObject(peticion);
    ...
    public ArrayList<Lista> leerListas() throws ExcepcionBP, ExcepcionBPComunicaciones{
        ...
        try {
            ...
            ObjectOutputStream oos = new ObjectOutputStream(socketCliente.getOutputStream());
            Peticion peticion = new Peticion(Peticion.LEER_LISTAS);
            oos.writeObject(peticion);
            ...
            if(!respuesta.equals(null)){
                ...
                ArrayList<Lista> listas = (ArrayList<Lista>) respuesta;
                return listas;
            }
            else if (respuesta.equals(null)){
